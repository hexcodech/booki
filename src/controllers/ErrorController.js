	...
	constructor(i18n) {
		...
		this.errorMessages = {
			...
			LoginError: {
				...
				defaultMessage: i18n.__(
					"Your login attempt with the provided credentials failed"
				),
			...
			DatabaseError: {
				...
				defaultResponse: i18n.__(
					"This is probably our fault. Please contact the support."
				)
			},
			...
			UnexpectedQueryResultError: {
				...
				code: 602,
				defaultMessage: i18n.__(
					"The database query returned an unexpected result"
				),
			...
			UserAlreadyExistsError: {
				...
				defaultResponse: i18n.__(
					"Verify that you still own this email address."
				)
			},
			...
			InvalidImageError: {
				...
				defaultResponse: i18n.__("Please check the image you uploaded.")
			}
		};
		...
		for (errorKey in this.errorMessages) {
			...
			if ("parent" in this.errorMessages[errorKey]) {
				this.errorMessages[errorKey].parent = this.errors[
